...
(function () {
    ...
    function load() {
        ...
        if (inArray(includes, 'turf')) {
            inputScript('libs/turf/6.5.0/turf.min.js');
        }
        ...
        if (inArray(includes, 'd3')) {
            inputScript('libs/d3/7.4.4/d3.min.js');
        }
        if (inArray(includes, 'd3-hexbin')) {
            inputScript('libs/d3/d3-hexbin.v0.2.min.js');
        }
        if (inArray(includes, 'd3Layer')) {
            inputScript('libs/leaflet/plugins/leaflet.d3Layer/leaflet-d3Layer.js');
        }
        ...
        if (inArray(includes, 'iclient-plot-leaflet')) {
            inputCSS('libs/plotting/leaflet/11.0.1/iclient-plot-leaflet.css');
            if (supportES6()) {
                inputScript('libs/plotting/leaflet/11.0.1/iclient-plot-leaflet-es6.min.js');
            } else {
                inputScript('libs/plotting/leaflet/11.0.1/iclient-plot-leaflet.min.js');
            }
        }
